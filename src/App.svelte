...
<nav class="flex items-center z-20 h-14 relative text-gray-700 border-b-2 bg-white">
	<div class="md:w-96 border-r border-light-gray h-full">
		<a class="text-l font-medium leading-none flex place-items-center pl-6 h-full" href="/">
...
<div class="flex bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-400">
	<div class="min-h-screen md:sticky z-10 self-start top-0 border-solid border-r border-light-gray bg-white -mt-14 pt-14 ">
		<aside class="flex-start md:left-0 md:block h-full md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-no-wrap md:overflow-hidden items-center justify-between relative md:w-96 pb-4 px-6">
		...
		<main class="min-h-screen -mt-14 pt-14 w-full px-4 pb-4 bg-gray-50">
			<Alert type="info">
