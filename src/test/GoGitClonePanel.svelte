...
<div class="my-3">
	...
	<div class="relative">
		<button disabled={disabled} on:click={() => visible = !visible} class="h-5 w-5 rounded-full overflow-hidden focus:outline-none absolute right-0 -top-7">
		...
		{#if visible}
		  <div class="absolute right-0 w-300 mt-2 p-4 bg-white border rounded shadow-xl z-30">   
			  <div class="text-sm">
				  <p>
					  <b>CORS proxy:</b><br/>
